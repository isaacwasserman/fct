...
class ViT:
    ...
    def log_test(self, test_loader, epoch):
        with torch.no_grad():
            ...
            grid = create_image_grid_seg(imgs, preds, labels, grid_size=(16, 16))
...
if __name__ == "__main__":
    ...
    model_kwargs = light_vit_equivalent_kwargs

    train_loader, val_loader, test_loader = get_dataset(
        batch_size=128, ds_len=45000, train_transform=train_transform, test_transform=test_transform, num_workers=num_workers
    )
